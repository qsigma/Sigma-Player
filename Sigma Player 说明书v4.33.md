...
<img width="705" alt="image" src="https://github.com/user-attachments/assets/a7f06310-d71c-4bb5-9eda-d9c75f4c4952">
...
> Midi 转谱无法手动编辑黑键，请使用更专业的编曲软件处理完 Midi 文件再进行转谱。
> 您无法在 Midi 转谱的引导界面执行编辑，如有需要请在流式编曲中进一步修改。
> Midi 转谱无法识别 midi 文件中的修改 bpm 的事件。如有需要请在导出后在对应位置添加新的速度。
